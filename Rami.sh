...
# These MUST NOT reuse WS ports
PORT_REALITY=${PORTS[12]}
PORT_TLS=${PORTS[13]}

PORT_VLESS_TCP=${PORTS[14]}
PORT_VMESS_TCP=${PORTS[15]}
PORT_TROJAN_TCP=${PORTS[16]}
PORT_SS_TCP=${PORTS[17]}
PORT_HYSTERIA2=${PORTS[18]}
